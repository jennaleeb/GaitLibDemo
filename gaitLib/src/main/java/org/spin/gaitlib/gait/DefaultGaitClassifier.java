...
public class DefaultGaitClassifier extends GaitClassifier {
    ...
    private static final String DEFAULT_MODEL_LOCATION = "Android/data/org.spin.gaitlib/files/personalized_model.model";
    private static final String DEFAULT_MODEL_XML_LOCATION = "Android/data/org.spin.gaitlib/files/personalized.xml";
    ...
    public void FileRetrievalHelper(Context context) {
